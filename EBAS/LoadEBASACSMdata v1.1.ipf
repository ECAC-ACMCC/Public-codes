...
Function LoadEBASACSMfiles()
    ...
    do
        ...
        LoadWave/A=Nitrate/Q/O/J/D/K=0/L={0,1,0,2,1}/V={","," $",0,0}/P=pathName file
        LoadWave/A=Ammonium/Q/O/J/D/K=0/L={0,1,0,3,1}/V={","," $",0,0}/P=pathName file
        LoadWave/A=Sulphate/Q/O/J/D/K=0/L={0,1,0,4,1}/V={","," $",0,0}/P=pathName file
        LoadWave/A=Chloride/Q/O/J/D/K=0/L={0,1,0,5,1}/V={","," $",0,0}/P=pathName file
        
        LoadWave/A=ACSMtime/Q/J/V={","," $",0,0}/L={0,1,0,0,1}/R={French,2,2,2,1,"Year-Month-DayOfMonth",40}/P=pathName file
        
        wave ACSMtime0, Organic0, Nitrate0, Ammonium0, Sulphate0, Chloride0
        Rename ACSMtime0, ACSMtime
        Rename Organic0, Organic
        Rename Nitrate0, Nitrate
        Rename Ammonium0, Ammonium
        Rename Sulphate0, Sulphate
        Rename Chloride0, Chloride
